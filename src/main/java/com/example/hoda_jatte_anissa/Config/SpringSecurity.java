        ...
        http.csrf().disable()
                .authorizeHttpRequests((authorize) ->
                        authorize.requestMatchers("/register/**").permitAll()
                                ...
                                .requestMatchers("/dashboardAdmin").hasAnyAuthority("Admin")
                                .requestMatchers("/demandes").hasAnyAuthority("Admin")
                                .requestMatchers("/demandes-acceptees").hasAnyAuthority("Admin")
                                .requestMatchers("/demandes-refusees").hasAnyAuthority("Admin")
                                ...
                                .requestMatchers("/dashboardUser").hasAnyAuthority("User")
                                .requestMatchers("/demandeStage").hasAnyAuthority("User")
